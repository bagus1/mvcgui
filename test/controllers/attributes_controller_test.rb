...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { field: @attribute.field, modelid: @attribute.modelid, schema: @attribute.schema, tablename: @attribute.tablename }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { field: @attribute.field, modelid: @attribute.modelid, schema: @attribute.schema, tablename: @attribute.tablename }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
