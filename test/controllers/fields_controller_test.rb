...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { field: @field.field, modelid: @field.modelid, schema: @field.schema, tablename: @field.tablename }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { field: @field.field, modelid: @field.modelid, schema: @field.schema, tablename: @field.tablename }
    assert_redirected_to field_path(assigns(:field))
  end
